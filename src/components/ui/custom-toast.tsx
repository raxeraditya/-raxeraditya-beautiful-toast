...
const getIcon = (variant: "default" | "success" | "error" | "info" | null | undefined) => {
  switch (variant) {
    case "success":
...
export function CustomToast({ t, message, onUndo, variant, icon }: CustomToastProps) {
  return (
        ...
        {onUndo && (
          <button
            ...
            className={cn(
              ...
              variant === "success" && "text-green-900 dark:text-green-200 hover:bg-green-100 dark:hover:bg-green-900",
              variant === "error" && "text-red-900 dark:text-red-200 hover:bg-red-100 dark:hover:bg-red-900",
              variant === "info" && "text-blue-900 dark:text-blue-200 hover:bg-blue-100 dark:hover:bg-blue-900"
            )}
          >
            Undo
          </button>
